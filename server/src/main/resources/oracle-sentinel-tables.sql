CREATE TABLE sentinel_monitor (
    ...
    min_consecutive_breaches  NUMBER DEFAULT 1 NOT NULL,
...
CREATE TABLE sentinel_trigger_state (
    ...
    channel_id                  CHAR(36) NOT NULL,
    metadata_id                 NUMBER,
    state                       VARCHAR2(20) DEFAULT 'INSUFFICIENT_DATA' NOT NULL,
    consecutive_breach_count    NUMBER DEFAULT 0 NOT NULL,
...
CREATE TABLE sentinel_channel_activity_sample (
    ...
    received_delta   NUMBER DEFAULT 0 NOT NULL,
    sent_delta       NUMBER DEFAULT 0 NOT NULL,
    error_delta      NUMBER DEFAULT 0 NOT NULL,
    filtered_delta   NUMBER DEFAULT 0 NOT NULL,
    queued_snapshot  NUMBER DEFAULT 0 NOT NULL
)
...
CREATE TABLE sentinel_channel_activity_trend (
    ...
    received_sum   NUMBER DEFAULT 0 NOT NULL,
    sent_sum       NUMBER DEFAULT 0 NOT NULL,
    error_sum      NUMBER DEFAULT 0 NOT NULL,
    avg_queued     DOUBLE PRECISION DEFAULT 0 NOT NULL,
    min_queued     NUMBER DEFAULT 0 NOT NULL,
    max_queued     NUMBER DEFAULT 0 NOT NULL,
...
CREATE TABLE sentinel_action (
    ...
    operation_mode            VARCHAR2(16) DEFAULT 'ON_PROBLEM' NOT NULL,
